...
- [energy_project_task3](Git_energy_model/Code/energy_project_task3): this is Olivia's wonderful code for task 3 (and 2, for the baseline), which creates the line of pareto optimal models when either constraining on GWP or total cost
