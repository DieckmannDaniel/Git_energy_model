...
- [energy_project_task3](Code/energy_project_task3.ipynb): this is Olivia's wonderful code for task 3 (and 2, for the baseline), which creates the line of pareto optimal models when either constraining on GWP or total cost
- [visualization](Code/visualization.ipynb): this is the code which creates the visualizations of the code (or at least a first one, as simple bar chart, until now)
